      ...
      <aside className="flex h-screen w-14 flex-col border-r bg-muted/30">
        ...
        <nav className="flex-1 space-y-1 overflow-auto p-2">
          ...
          <CollapsedLink
            ...
            label="Persona"
            icon="🧬"
            active={pathname === "/persona" || pathname.startsWith("/persona/")}
          />
          <CollapsedLink
            href="/about-me"
            label="About Me"
            icon="👤"
            active={pathname === "/about-me" || pathname.startsWith("/about-me/")}
          />
          <CollapsedLink
            href="/self"
    ...
    <aside className="flex h-screen w-56 flex-col border-r bg-muted/30">
      ...
      <nav className="flex-1 space-y-1 overflow-auto p-3">
        ...
        <Link
          ...
          className={cn(
            "flex items-center gap-2 rounded-md px-3 py-2 text-sm transition-colors",
            pathname === "/about-me" || pathname.startsWith("/about-me/")
              ? "bg-accent text-accent-foreground font-medium"
              : "text-muted-foreground hover:bg-accent/50 hover:text-foreground",
          )}
        >
