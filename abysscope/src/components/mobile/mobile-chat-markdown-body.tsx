 ...
 * fenced code, lists, links). We use ``prose prose-base`` (16px body)
 * to match the Claude mobile app's reading size — the desktop chat
 * keeps ``prose-sm`` since a pointer + wider viewport read fine at
 * 14px, but a phone held at arm's length needs the larger body.
 * ``break-words`` + ``[overflow-wrap:anywhere]`` keep long URLs /
 * Korean text from blowing past the bubble width on narrow phones.
 */
